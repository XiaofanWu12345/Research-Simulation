...
SLIST = [s/10 for s in range(1,10)] + [s/10000 for s in range(9100,10000,2)]
#SLIST = [s/100 for s in range(91,100)]
# a list iof traffic intensity values from 0.1, 0.2 to 0.9, 0.91,0.9102,0.9104 to 0.9998
