...
PLIST = ["MaxWt", "Pri_E", "MaxSize_PriMaxWt", "MaxSize_PriMaxWtLog"] # "Algo_3","Algo_2"
LABELS = ["MaxWeight", "MSC", "MSMW", "MSMWLog"] #  "Algo_3", "Algo_2"
...
def main(args):
    for Vs in VLIST:
        ...
        y = [float(S)**2/4 for S in subfigure[0]]
        ...
        plt.xlabel(r'\text{Traffic Intensity }'
                   r'$(\rho)$',
                   fontsize=10)
        plt.ylabel(r'$(1-\rho) E\left[\sum_{i,j} Q_{i,j}\right]$', fontsize=10)
