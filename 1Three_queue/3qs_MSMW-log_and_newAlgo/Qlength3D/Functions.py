...
def Pri_E(q11, q22, q12, q21, lambda11, lambda22, lambda12, lambda21):
    l11 = 0
    l22 = 0
    l12 = 0
...
#Returns a list of updated queue length after applying the Algorithm 2
#The order of the queue length values in the list is queue11, queue12, queue21
def Algo_2(q11, q22, q12, q21, lambda11, lambda22, lambda12, lambda21):
    l11 = 0
    l22 = 0
    l12 = 0
    l21 = 0  # Actual arrivals
    ...
    if random.random() < lambda21:
        ...
        q21 += 1
        # Update queue lengths and actual arrivals
    if ((q12 == 0) and (q21 > q11 > 0)) or ((q21 == 0) and (q12 > q11 > 0)):
        qlist = Pri_E(q11, q22, q12, q21, 0, 0, 0, 0)
    else:
        qlist = MaxWt(q11, q22, q12, q21, 0, 0, 0, 0)
    return qlist

#Returns a list of updated queue length after applying the Algorithm 3
#The order of the queue length values in the list is queue11, queue12, queue21
def Algo_3(q11, q22, q12, q21, lambda11, lambda22, lambda12, lambda21):
    l11 = 0
    l22 = 0
    l12 = 0
    l21 = 0  # Actual arrivals
    ...
    if random.random() < lambda21:
        ...
        q21 += 1
        # Update queue lengths and actual arrivals
    if q11 > q12 + q21 and ((q12 > 0) and (q21 > 0)):
        qlist = Pri_E(q11, q22, q12, q21, 0, 0, 0, 0)
    else:
        qlist = MaxWt(q11, q22, q12, q21, 0, 0, 0, 0)
    return qlist
